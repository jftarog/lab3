...
<h1 id="myHeader" class="blurbox">Welcome to my website!</h1>
<div class="flip"><a class="button flip" onclick="onClick()">Click to show my profile!</a></div>
<p class="flip" style="color: white;">It is currently <a id="demo"></a>.</p>
<div id="profile" class="blurbox">
